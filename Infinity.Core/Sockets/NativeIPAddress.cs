...
using Infinity.Core.Sockets.Native.Win32;
...
namespace Infinity.Core.Sockets
{
    ...
    public class NativeIPAddress
    {
        ...
        public static bool IsLoopback(NativeIPAddress address)
        {
            ...
            {
                return ((address.m_Address & NativeIPAddress.LoopbackMask) == (NativeIPAddress.Loopback.m_Address & NativeIPAddress.LoopbackMask));
            }
        }
        ...
        public NativeIPAddress MapToIPv6()
        {
            ...
            ushort[] labels = new ushort[NativeIPAddress.NumberOfLabels];
            labels[5] = 0xFFFF;
