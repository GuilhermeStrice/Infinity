...
public unsafe struct MessageWriter
{
    ...
    {
        throw new InfinityException("MessageWriter must be created with a BufferChunk or ChunkedByteAllocator");
    }

    public MessageWriter(BufferChunk chunk)
    {
        _chunk = chunk;
        Position = 0;
    }

    public MessageWriter(ChunkedByteAllocator allocator)
    {
